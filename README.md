...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/r-gdalraster-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-gdalraster-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi global install r-gdalraster
```
...
It is possible to list all of the versions of `r-gdalraster` available on your platform:
...
```
pixi search r-gdalraster --channel conda-forge
```
